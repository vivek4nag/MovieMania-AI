        ...
        {movieNames ? (
          <>
            ...
            <div className="mt-12  text-gray-200 p-4 text-center text-sm rounded-md">
              ⚠️ <span className="font-semibold">Disclaimer:</span> AI might
              sometimes suggest unrelated movies or inaccuracies. Please use
              your judgement & verify the details. Enjoy your movie journey!
            </div>
          </>
        ) : (
          <>
